...
let lastCar = 0;
console.log('The last car in the inventory list is a: ' + inventory[inventory.length-1].car_make + ' ' + inventory[inventory.length-1].car_model);
...
//I'd like to remove the duplicates. I'll come back to this
...
console.log('There are a total of: ' + oldCars.length + ' cars in the dealership inventory made before the year 2000'); 
